...
extern int keyPushed1;
extern int keyPushed2;
...
bool GameplayState::Update(bool processInput)
{
	if (processInput && !m_beatLevel)
	{
		...
		// Commented out above and added below to force game to update even without player moving
		HandleCollision(newPlayerX, newPlayerY);
	}
	...
	keyPushed1 = 0;		// Resetting value so game doesn't think previous key is being held down
	keyPushed2 = 0;		// Resetting value so game doesn't think previous key is being held down
